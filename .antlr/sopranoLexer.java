...
public class sopranoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "LB", "RB", "LS", "RS", "LC", 
			"RC", "LP", "RP", "ASSIGN", "SIZE", "CORTA", "AGREGA", "REPROD", "MUL", 
			"DIV", "MOD", "SUM", "RESTA", "EQ", "NEQ", "GT", "LT", "GET", "LET", 
			"PROCNAME", "NOTA", "VAR", "NUM", "STRING", "COMMENT", "WS"
		};
	}
	...
	public sopranoLexer(CharStream input) {
		super(input);
